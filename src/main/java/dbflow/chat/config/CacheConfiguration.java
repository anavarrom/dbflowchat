...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, dbflow.chat.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dbflow.chat.repository.UserRepository.USERS_BY_EMAIL_CACHE);
